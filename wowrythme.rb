...
new_content = new_content.gsub(pattern) do |match|
  ...
  patterns = [
    ...
    /\b(?<!AutoBarline|upbow|downbow|staccato|tuplet|partial|AutoEndMovementBarline)((aes|ais|bes|bis|ces|cis|des|dis|ees|eis|fes|fis|ges|gis|a|b|c|d|e|f)'*)\b/
  ]
  f=0
